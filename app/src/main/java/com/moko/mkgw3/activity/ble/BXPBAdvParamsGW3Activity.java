...
public class BXPBAdvParamsGW3Activity extends BaseActivity<ActivityBxpBDAdvParamsKgw3Binding> {
            ...
            for (AdvChannel advChannel : result.data.adv_param) {
                if (advChannel.channel == 0 && advChannel.enable == 1) {
                    ...
                    if (advChannel.channel_type == 0) {
                        ...
                        mBind.layoutSingleNormal.etAdvInterval.setText(String.valueOf(advChannel.normal_adv.adv_interval / 100));
                        ...
                        mBind.layoutSingleAfterAdv.etAdvInterval.setText(String.valueOf(advChannel.trigger_after_adv.adv_interval / 100));
                        ...
                        mBind.layoutSingleBeforeAdv.etAdvInterval.setText(String.valueOf(advChannel.trigger_before_adv.adv_interval / 100));
                        ...
                        mBind.layoutSingleTriggerAdv.etAdvInterval.setText(String.valueOf(advChannel.trigger_after_adv.adv_interval / 100));
                ...
                if (advChannel.channel == 1 && advChannel.enable == 1) {
                    ...
                    if (advChannel.channel_type == 0) {
                        ...
                        mBind.layoutDoubleNormal.etAdvInterval.setText(String.valueOf(advChannel.normal_adv.adv_interval / 100));
                        ...
                        mBind.layoutDoubleAfterAdv.etAdvInterval.setText(String.valueOf(advChannel.trigger_after_adv.adv_interval / 100));
                        ...
                        mBind.layoutDoubleBeforeAdv.etAdvInterval.setText(String.valueOf(advChannel.trigger_before_adv.adv_interval / 100));
                        ...
                        mBind.layoutDoubleTriggerAdv.etAdvInterval.setText(String.valueOf(advChannel.trigger_after_adv.adv_interval / 100));
                ...
                if (advChannel.channel == 2 && advChannel.enable == 1) {
                    ...
                    if (advChannel.channel_type == 0) {
                        ...
                        mBind.layoutLongNormal.etAdvInterval.setText(String.valueOf(advChannel.normal_adv.adv_interval / 100));
                        ...
                        mBind.layoutLongAfterAdv.etAdvInterval.setText(String.valueOf(advChannel.trigger_after_adv.adv_interval / 100));
                        ...
                        mBind.layoutLongBeforeAdv.etAdvInterval.setText(String.valueOf(advChannel.trigger_before_adv.adv_interval / 100));
                        ...
                        mBind.layoutLongTriggerAdv.etAdvInterval.setText(String.valueOf(advChannel.trigger_after_adv.adv_interval / 100));
                ...
                if (advChannel.channel == 3 && advChannel.enable == 1) {
                    ...
                    if (advChannel.channel_type == 0) {
                        ...
                        mBind.layoutAbnormalInactivityNormal.etAdvInterval.setText(String.valueOf(advChannel.normal_adv.adv_interval / 100));
                        ...
                        mBind.layoutAbnormalInactivityAfterAdv.etAdvInterval.setText(String.valueOf(advChannel.trigger_after_adv.adv_interval / 100));
                        ...
                        mBind.layoutAbnormalInactivityBeforeAdv.etAdvInterval.setText(String.valueOf(advChannel.trigger_before_adv.adv_interval / 100));
                        ...
                        mBind.layoutAbnormalInactivityTriggerAdv.etAdvInterval.setText(String.valueOf(advChannel.trigger_after_adv.adv_interval / 100));
    ...
    public void onTxPower(View view) {
        ...
        int selected = TxPowerEnum.fromTxPower(txPower).ordinal();
