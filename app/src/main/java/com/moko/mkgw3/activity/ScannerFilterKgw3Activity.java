...
public class ScannerFilterKgw3Activity extends BaseActivity<ActivityScannerFilterKgw3Binding> implements SeekBar.OnSeekBarChangeListener {
    ...
    @Override
    protected ActivityScannerFilterKgw3Binding getViewBinding() {
        return ActivityScannerFilterKgw3Binding.inflate(getLayoutInflater());
    }
