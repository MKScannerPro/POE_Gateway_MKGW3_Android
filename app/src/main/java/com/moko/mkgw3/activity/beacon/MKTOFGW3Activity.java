...
import com.moko.mkgw3.databinding.ActivityMkTofInfoKgw3Binding;
...
public class MKTOFGW3Activity extends BaseActivity<ActivityMkTofInfoKgw3Binding> {
    ...
    @Override
    protected ActivityMkTofInfoKgw3Binding getViewBinding() {
        return ActivityMkTofInfoKgw3Binding.inflate(getLayoutInflater());
    }
    ...
    private void gotoSensorData() {
        if (isWindowLocked()) return;
        Intent intent = new Intent(this, MKTOFSensorDataGW3Activity.class);
        intent.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDeviceKgw3);
        intent.putExtra(AppConstants.EXTRA_KEY_MAC, mBeaconInfo.mac);
        startActivity(intent);
    }
    ...
    private void gotoSensorParams() {
        if (isWindowLocked()) return;
        Intent intent = new Intent(this, MKTOFSensorParamsGW3Activity.class);
        intent.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDeviceKgw3);
        intent.putExtra(AppConstants.EXTRA_KEY_MAC, mBeaconInfo.mac);
        intent.putExtra(AppConstants.EXTRA_KEY_BEACON_TYPE, mBeaconInfo.type);
        startActivity(intent);
    ...
    private void gotoAdvParams() {
        if (isWindowLocked()) return;
        Intent intent = new Intent(this, MKTOFAdvParamsGW3Activity.class);
        intent.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDeviceKgw3);
        intent.putExtra(AppConstants.EXTRA_KEY_MAC, mBeaconInfo.mac);
        startActivity(intent);
    }
