...
public class CommunicateTimeoutKgw3Activity extends BaseActivity<ActivityCommunicateTimeoutKgw3Binding> {
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_COMMUNICATION_TIMEOUT
                || msg_id == MQTTConstants.READ_MSG_ID_BLE_CONNECT_TIMEOUT) {
        ...
        if (msg_id == MQTTConstants.CONFIG_MSG_ID_COMMUNICATION_TIMEOUT
                || msg_id == MQTTConstants.CONFIG_MSG_ID_BLE_CONNECT_TIMEOUT) {
    ...
    private void setCommunicationTimeout(int timeout) {
        ...
        if (mMokoDeviceKgw3.deviceType == 1)
            msgId = MQTTConstants.CONFIG_MSG_ID_BLE_CONNECT_TIMEOUT;
