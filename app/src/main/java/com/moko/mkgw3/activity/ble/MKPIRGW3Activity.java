...
import com.moko.mkgw3.databinding.ActivityMkPirInfoKgw3Binding;
...
public class MKPIRGW3Activity extends BaseActivity<ActivityMkPirInfoKgw3Binding> {
    ...
    @Override
    protected ActivityMkPirInfoKgw3Binding getViewBinding() {
        return ActivityMkPirInfoKgw3Binding.inflate(getLayoutInflater());
    }
    ...
    protected void onCreate() {
        ...
        mBind.tvRuntime.setText(mBeaconInfo.run_time);
    ...
    private void gotoSensorData() {
        ...
        Intent intent = new Intent(this, MKPIRSensorDataGW3Activity.class);
        intent.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDeviceKgw3);
        intent.putExtra(AppConstants.EXTRA_KEY_MAC, mBeaconInfo.mac);
        startActivity(intent);
    }
    ...
    private void gotoSensorParams() {
        if (isWindowLocked()) return;
        Intent intent = new Intent(this, MKPIRSensorParamsGW3Activity.class);
        intent.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDeviceKgw3);
        intent.putExtra(AppConstants.EXTRA_KEY_MAC, mBeaconInfo.mac);
        intent.putExtra(AppConstants.EXTRA_KEY_BEACON_TYPE, mBeaconInfo.type);
        startActivity(intent);
    ...
    private void gotoAdvParams() {
        if (isWindowLocked()) return;
        Intent intent = new Intent(this, MKAdvParamsGW3Activity.class);
        intent.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDeviceKgw3);
        intent.putExtra(AppConstants.EXTRA_KEY_MAC, mBeaconInfo.mac);
        intent.putExtra(AppConstants.EXTRA_KEY_BEACON_TYPE, mBeaconInfo.type);
        startActivity(intent);
