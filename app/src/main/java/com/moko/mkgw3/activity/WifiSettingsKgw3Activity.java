...
import com.moko.mkgw3.databinding.ActivityWifiSettingsKgw3Binding;
...
public class WifiSettingsKgw3Activity extends BaseActivity<ActivityWifiSettingsKgw3Binding> {
    ...
    @Override
    protected ActivityWifiSettingsKgw3Binding getViewBinding() {
        return ActivityWifiSettingsKgw3Binding.inflate(getLayoutInflater());
    }
