...
import com.moko.mkgw3.databinding.ActivityFilterBxpTagKgw3Binding;
...
public class FilterBXPTagKgw3Activity extends BaseActivity<ActivityFilterBxpTagKgw3Binding> {
    ...
    protected void onCreate() {
        ...
        mBind.tvTitle.setText(mMokoDeviceKgw3.deviceType != 0 ? "BXP- Tag/Sensor" : "BXP- Tag");
        mBind.cbBxpTag.setText(mMokoDeviceKgw3.deviceType != 0 ? "BXP- Tag/Sensor" : "BXP- Tag");
    ...
    @Override
    protected ActivityFilterBxpTagKgw3Binding getViewBinding() {
        return ActivityFilterBxpTagKgw3Binding.inflate(getLayoutInflater());
    }
