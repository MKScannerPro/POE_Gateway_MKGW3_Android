...
import com.moko.mkgw3.databinding.ActivityBxpDInfoKgw3Binding;
import com.moko.mkgw3.databinding.ActivityBxpTInfoKgw3Binding;
...
public class BXPTGW3Activity extends BaseActivity<ActivityBxpTInfoKgw3Binding> {
    ...
    @Override
    protected ActivityBxpTInfoKgw3Binding getViewBinding() {
        return ActivityBxpTInfoKgw3Binding.inflate(getLayoutInflater());
    }
    ...
    private void gotoMotionEventData() {
        ...
        Intent intent = new Intent(this, BXPTMotionEventGW3Activity.class);
