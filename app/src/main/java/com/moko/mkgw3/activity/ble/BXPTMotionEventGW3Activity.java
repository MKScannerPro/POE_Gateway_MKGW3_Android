...
import com.moko.mkgw3.databinding.ActivityBxpTMotionEventKgw3Binding;
...
public class BXPTMotionEventGW3Activity extends BaseActivity<ActivityBxpTMotionEventKgw3Binding> {
    ...
    @Override
    protected ActivityBxpTMotionEventKgw3Binding getViewBinding() {
        return ActivityBxpTMotionEventKgw3Binding.inflate(getLayoutInflater());
    }
