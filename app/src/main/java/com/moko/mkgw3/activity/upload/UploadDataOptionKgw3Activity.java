...
import com.moko.mkgw3.databinding.ActivityUploadDataOptionKgw3Binding;
...
public class UploadDataOptionKgw3Activity extends BaseActivity<ActivityUploadDataOptionKgw3Binding> {
    ...
    protected void onCreate() {
        ...
        mBind.cbRawDataAdv.setText(mMokoDeviceKgw3.deviceType == 0 ? "RAW Data-Advertising" : "ADV data");
        mBind.cbRawDataRsp.setVisibility(mMokoDeviceKgw3.deviceType == 0 ? View.VISIBLE : View.GONE);
    ...
    @Override
    protected ActivityUploadDataOptionKgw3Binding getViewBinding() {
        return ActivityUploadDataOptionKgw3Binding.inflate(getLayoutInflater());
    }
