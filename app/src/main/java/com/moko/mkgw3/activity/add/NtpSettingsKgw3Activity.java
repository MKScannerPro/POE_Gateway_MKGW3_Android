...
public class NtpSettingsKgw3Activity extends BaseActivity<ActivityNtpSettingsKgw3Binding> {
    ...
    @Override
    protected ActivityNtpSettingsKgw3Binding getViewBinding() {
        return ActivityNtpSettingsKgw3Binding.inflate(getLayoutInflater());
    }
